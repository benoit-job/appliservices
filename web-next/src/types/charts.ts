...
export const TYPES_GRAPHIQUES: Array<{ id: string; label: string; icon: string }> = [
  { id: "evolution_financiere", label: "Évolution financière", icon: "📈" },
  { id: "repartition_activites", label: "Répartition activités", icon: "📊" },
  { id: "resultat_activites", label: "Résultat par activité", icon: "💰" },
  ...
  { id: "modes_paiement", label: "Modes de paiement", icon: "💳" },
